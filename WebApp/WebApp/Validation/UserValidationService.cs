...
{
    public interface IUserValidator : IValidationService<UserModel>
    {

    }
    public sealed class UserValidationService : FluentValidationService<UserModel>, IUserValidator
    {
